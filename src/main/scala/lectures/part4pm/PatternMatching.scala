...
//    case _ => "something else " // _ = WILDCARD
  ...
  /*
    ...
    3. type if the PM Expression ? unified type of all types in all the cases
  ...
  println(show(Prod(Sum(Number(2), Number(1)), Number(4))))
  println(show(Sum(Prod(Number(2), Number(1)), Number(4))))
